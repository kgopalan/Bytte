//
//  BYTAddTextToPhotoViewController.m
//  Bytte
//
...
@interface BYTAddTextToPhotoViewController () <UITextViewDelegate>
...
@implementation BYTAddTextToPhotoViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (self.lightBytte.bytteText) {
        self.textView.text = self.lightBytte.bytteText;
    }
