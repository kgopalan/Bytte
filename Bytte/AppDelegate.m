...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    [BYTDataSource sharedInstance];
    
    UIColor *navigationColor = [UIColor colorWithRed:28.0/255.0 green:28.0/255.0 blue:28.0/255.0 alpha:1.0];
    [[UINavigationBar appearance] setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:
                                                           navigationColor, NSForegroundColorAttributeName,
                                                           [UIFont fontWithName:@"OpenSans-Semibold" size:12.0f], NSFontAttributeName, nil]];
